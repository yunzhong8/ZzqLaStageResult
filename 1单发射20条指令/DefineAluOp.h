...
//ALU操作码
    ...
    //比较运算
      ...
      //复杂运算
        `define MulAluOp        `AluOpLen'd11//乘法
        `define MuluAluOp       `AluOpLen'd12//无符号乘
        `define DivAluOp        `AluOpLen'd13//除法
        `define ModAluOp        `AluOpLen'd14//取模
        `define DivuAluOp       `AluOpLen'd15//无符号除
        `define ModuAluOp       `AluOpLen'd16//无符号取模
        `define NoAluOp         `AluOpLen'd13//误操作
        `define LuiAluOp        `AluOpLen'd14
