...
//控制信号
 ...
 //OP8指令
     //原子访存指令
            `define LlwInstIdSign            `IdSignLen'h0C00
            `define ScwInstIdSign            `IdSignLen'h1400
 //Op10指令
     //比较指令
 ...
 //op22
     //时间预取指令
            `define RdcntidwInstIdSign       `IdSignLen'h02c0
            `define RdcntvlwInstIdSign       `IdSignLen'h0180
            `define RdcntvhwInstIdSign       `IdSignLen'h0200

//核心态指令
    //csr访问指令
           `define CsrrdInstIdSign           `IdSignLen'h0280
           `define CsrwrInstIdSign           `IdSignLen'h0281
    ...
    //其他指令                                             0000
         ...
         `define NoInstIdSign                `IdSignLen'h0000
