...
//控制信号
 ...
 //OP8指
     //原子访存指
            `define LlwInstMemSign            `MemSignLen'h00
            `define ScwInstMemSign            `MemSignLen'h00
 //Op10指
     //比较指
    ...
    //逻辑运算指
       ...
       //访存指
        //加载指
            `define LdbInstMemSign            `MemSignLen'h16
            `define LdhInstMemSign            `MemSignLen'h0E
            `define LdwInstMemSign            `MemSignLen'h02


         //存储指
            `define StbInstMemSign            `MemSignLen'h11
            `define SthInstMemSign            `MemSignLen'h09
            `define StwInstMemSign            `MemSignLen'h01
        //0扩展加载指
            `define LdbuInstMemSign           `MemSignLen'h12
            `define LdhuInstMemSign           `MemSignLen'h0A
        //cache预取指
...
//核心态指
    ...
    //其他指令                                          
         ...
         `define NoInstMemSign                `MemSignLen'h00
