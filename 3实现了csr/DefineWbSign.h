...
//控制信号
 ...
 //OP8指令
     //原子访存指令
            `define LlwInstWbSign            `WbSignLen'h3
            `define ScwInstWbSign            `WbSignLen'h2
 //Op10指令
     //比较指令
 ...
 //op17指令
     ...
     //栅障指令
             `define DbarInstWbSign          `WbSignLen'h0
             `define IbarInstWbSign          `WbSignLen'h0
 //op22
     //时间预取指令
            `define RdcntidwInstWbSign       `WbSignLen'h1
            `define RdcntvlwInstWbSign       `WbSignLen'h1
            `define RdcntvhwInstWbSign       `WbSignLen'h1
//核心态指令
    //csr访问指令
           `define CsrrdInstWbSign           `WbSignLen'h1

           `define CsrwrInstWbSign           `WbSignLen'h3
           `define CsrxchgInstWbSign         `WbSignLen'h3
           
    //cache维护指令                                      
           `define CacopInstWbSign           `WbSignLen'h0
     //Tlb维护指令                                       
          `define TlbsrchInstWbSign          `WbSignLen'h0
          `define TlbrdInstWbSign            `WbSignLen'h0
          `define TlbwrInstWbSign            `WbSignLen'h0
          `define TlbfillInstWbSign          `WbSignLen'h0
         `define InvtlbInstWbSign            `WbSignLen'h0
    //其他指令                                           
         `define IdleInstWbSign              `WbSignLen'h0
         `define ErtnInstWbSign              `WbSignLen'h0
         `define NoInstWbSign                `WbSignLen'h0
