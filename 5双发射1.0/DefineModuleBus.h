...
//绑定接口bus(那些数据是绑定同时出现的就使用相同bus)
  ...
  //线级
         ...
         `define LineRegsReadIbusLen `RegsAddrLen+`RegsAddrLen
...
//总线宽度
    ...
    //Id阶段
        ...
        `define LineIdToRfbBusLen  `RegsAddrLen+`RegsAddrLen
    ...
    //EXE阶段
        ...
        `define LineExForwardBusLen  `LlbitWriteBusLen+`LineRegsWriteBusLen+`spMemRegsWdataSrcLen+`EnLen
    ...
    //MEM阶段
        ...
        `define LineMemToWbBusWidth  `MemToWbBusLen-1 :0
